...
class Table_YYuTAb extends PageList {
        constructor(instName,accessAction) {
            super(instName,"/equipment",accessAction,"equipmentRecords","equipmentRecordsPagination",{url:"/equipment/delete",message:"Are you sure delete data ?"},{url:"/equipment/edit",target:""}, 
            {url:"/equipment/export"},["data.name?data.name:''","data. equipment_group_text?data. equipment_group_text:''","data.serial?data.serial:''"], "", "tbl-table_YYuTAb", "tbl-table_YYuTAb-pagination");
        }
        pagination(){super.pagination();}
        pageClick(page){if(page==undefined){page=1;}super.pageClick(page);}
...
class Table_gyuFKy extends PageList {
        constructor(instName,accessAction) {
            super(instName,"/equipment_group",accessAction,"equipment_groupRecords","equipment_groupRecordsPagination",{url:"/equipment_group/delete",message:"Are you sure delete data ?"},{url:"/equipment_group/edit",target:""}, 
            {url:"/equipment_group/export"},["data.code?data.code:''","data.name?data.name:''"], "", "tbl-table_gyuFKy", "tbl-table_gyuFKy-pagination");
        }
        pagination(){super.pagination();}
        pageClick(page){if(page==undefined){page=1;}super.pageClick(page);}
        render(data,summaryDatas) {super.render(data,summaryDatas);}
...
class Table_wWCGHN extends PageList {
        constructor(instName,accessAction) {
            super(instName,"/borrow_equipment",accessAction,"borrow_equipmentRecords","borrow_equipmentRecordsPagination",{url:"/borrow_equipment/delete",message:"Are you sure delete data ?"},{url:"/borrow_equipment/edit",target:""}, 
            {url:"/borrow_equipment/export"},["data.firstname?data.firstname:''","data.lastname?data.lastname:''","data.start_date?moment(data.start_date).utc().format('DD/MM/YYYY'):''","data.return_date?moment(data.return_date).utc().format('DD/MM/YYYY'):''","data.return_status_text?data.return_status_text:''"], "", "tbl-table_wWCGHN", "tbl-table_wWCGHN-pagination");
        }
        pagination(){super.pagination();}
        pageClick(page){if(page==undefined){page=1;}super.pageClick(page);}
        render(data,summaryDatas) {super.render(data,summaryDatas);}
...
class Table_krUNxu extends PageList {
        constructor(instName,accessAction) {
            super(instName,"/borrower",accessAction,"borrowerRecords","borrowerRecordsPagination",{url:"/borrower/delete",message:"Are you sure delete data ?"},{url:"/borrower/edit",target:""}, 
            {url:"/borrower/export"},["data.firstname?data.firstname:''","data.lastname?data.lastname:''","data.employee_code?data.employee_code:''","data.position?data.position:''","data.business_unit?data.business_unit:''","data.department?data.department:''","data.phone?data.phone:''","data.email?data.email:''","data.remark?data.remark:''"], "", "tbl-table_krUNxu", "tbl-table_krUNxu-pagination");
        }
        pagination(){super.pagination();}
        pageClick(page){if(page==undefined){page=1;}super.pageClick(page);}
        render(data,summaryDatas) {super.render(data,summaryDatas);}
